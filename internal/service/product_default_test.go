...
func TestProductService_GetById(t *testing.T) {
	t.Run("Existing product", func(t *testing.T) {
		// Arrange
		mockRepo := new(MockProductRepository)
		product := &models.Product{ID: 1, ProductAttributes: models.ProductAttributes{ProductCode: "P1", Description: "Product 1"}}
...
func TestProductService_Create(t *testing.T) {
	// Arrange
	mockRepo := new(MockProductRepository)
	product := models.Product{ProductAttributes: models.ProductAttributes{Description: "New Product", ProductCode: "NP1"}}
...
func TestProductService_Update(t *testing.T) {
	t.Run("Update existing product", func(t *testing.T) {
		// Arrange
		mockRepo := new(MockProductRepository)
		existingProduct := &models.Product{ID: 1, ProductAttributes: models.ProductAttributes{ProductCode: "P1", Description: "Product 1"}}
		
		// Create a ProductDoc with updated description
		description := "Updated Product"
		productDoc := models.ProductDoc{Description: &description}
		
		// After mapping the doc to the struct
		updatedProduct := &models.Product{ID: 1, ProductAttributes: models.ProductAttributes{ProductCode: "P1", Description: "Updated Product"}}
